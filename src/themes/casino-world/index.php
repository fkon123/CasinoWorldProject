        ...
        <div class="container mx-auto py-12 relative z-10">
            <div class="flex justify-center items-start space-x-6">
                ...
                foreach ($casinos as $index => $casino) {
                    ...
                    if ($is_enabled) {
                        $container_class = 'w-1/3 bg-white text-black shadow-lg rounded-lg p-6 transform scale-110 relative';
                        ...
                        $container_class = 'w-1/4 bg-purple-800 text-white rounded-lg p-6 relative';
                        $great_offer_image = '';
